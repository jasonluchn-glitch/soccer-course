...
func setup(context_player: Player, context_state_data: PlayerStateData, context_animation_player, context_ball: Ball, context_teammate_detection_area : Area2D) -> void:
