...
const CONTROL_BALL_HEIGHT_MAX := 10.0
...
func switch_state(state: State, state_data: PlayerStateData = PlayerStateData.new()) -> void:
	...
	current_state.setup(self, state_data, animation_player, ball, teammate_detection, ball_detection_area, own_goal, target_goal)
...
func flip_sprite() -> void:
	player_sprite.flip_h = false if heading == Vector2.RIGHT else true
...
func control_ball() -> void:
	if ball.height > CONTROL_BALL_HEIGHT_MAX:
